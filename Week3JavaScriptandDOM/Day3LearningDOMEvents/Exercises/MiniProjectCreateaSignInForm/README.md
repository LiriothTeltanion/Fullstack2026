# Mini Project Createa Sign In Form
...
<img src="../../../../assets/readme/progress/mini-project-createa-sign-in-form-ba63e6bf9c.svg" width="100%" alt="Readiness status for Mini Project Createa Sign In Form">
...
- `Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/MiniProjectCreateaSignInForm/index.html`
- `Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/MiniProjectCreateaSignInForm/js/app.js`

### 🚀 Run

```bash
python -m http.server 8000
node Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/MiniProjectCreateaSignInForm/js/app.js
```
