# Day3 Learning DOM Events — Exercises XP
...
<img src="../../../../assets/readme/progress/exercises-xp-6babf4344d.svg" width="100%" alt="Readiness status for Exercises XP">
...
- `Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/ExercisesXP/dom_exercises.js`
- `Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/ExercisesXP/index_dom_exercises.html`

### 🚀 Run

```bash
node Week3JavaScriptandDOM/Day3LearningDOMEvents/Exercises/ExercisesXP/dom_exercises.js
...
```text
# Open index_dom_exercises.html in a browser or serve the repository locally
```

## Files

- `dom_exercises.js`
- `index_dom_exercises.html`
