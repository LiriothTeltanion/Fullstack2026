...
<img src="../../../../assets/readme/progress/daily-challenge-planets-bcd2f51b89.svg" width="100%" alt="Readiness status for Daily Challenge Planets">
...
- `Week3JavaScriptandDOM/Day2FunctionsandDOMIntroduction/DailyChallenge/DailyChallengePlanets/planets.html`
- `Week3JavaScriptandDOM/Day2FunctionsandDOMIntroduction/DailyChallenge/DailyChallengePlanets/planets.js`

### 🚀 Run

```bash
python -m http.server 8000
node Week3JavaScriptandDOM/Day2FunctionsandDOMIntroduction/DailyChallenge/DailyChallengePlanets/planets.js
```
...
```text
# Open planets.html in a browser or serve the repository locally
```
