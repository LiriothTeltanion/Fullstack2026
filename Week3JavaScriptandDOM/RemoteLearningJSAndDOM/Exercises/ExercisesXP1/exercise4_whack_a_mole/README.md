...
<img src="../../../../../assets/readme/progress/exercise4-whack-a-mole-e543b0681c.svg" width="100%" alt="Readiness status for Exercise4 whack a mole">
...
- `Week3JavaScriptandDOM/RemoteLearningJSAndDOM/Exercises/ExercisesXP1/exercise4_whack_a_mole/index.html`
- `Week3JavaScriptandDOM/RemoteLearningJSAndDOM/Exercises/ExercisesXP1/exercise4_whack_a_mole/js/app.js`

### 🚀 Run

```bash
python -m http.server 8000
node Week3JavaScriptandDOM/RemoteLearningJSAndDOM/Exercises/ExercisesXP1/exercise4_whack_a_mole/js/app.js
```
