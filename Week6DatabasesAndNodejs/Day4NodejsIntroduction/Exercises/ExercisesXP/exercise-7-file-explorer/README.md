...
<img src="../../../../../assets/readme/progress/exercise-7-file-explorer-cd77af1da3.svg" width="100%" alt="Readiness status for Exercise 7 file explorer">
...
- `Week6DatabasesAndNodejs/Day4NodejsIntroduction/Exercises/ExercisesXP/exercise-7-file-explorer/file-explorer/package.json`
...
```text
Add the exact run command after verifying the entry point.
```
