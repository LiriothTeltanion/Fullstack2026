...
<img src="../../../../../assets/readme/progress/exercise-4-esm-todo-8d35444102.svg" width="100%" alt="Readiness status for Exercise 4 esm todo">
...
- `Week6DatabasesAndNodejs/Day4NodejsIntroduction/Exercises/ExercisesXP/exercise-4-esm-todo/todoApp/package.json`

### 🚀 Run

```bash
node Week6DatabasesAndNodejs/Day4NodejsIntroduction/Exercises/ExercisesXP/exercise-4-esm-todo/todoApp/app.js
```
