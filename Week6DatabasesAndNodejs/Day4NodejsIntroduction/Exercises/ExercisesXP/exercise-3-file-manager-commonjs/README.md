...
<img src="../../../../../assets/readme/progress/exercise-3-file-manager-commonjs-d81ac35c81.svg" width="100%" alt="Readiness status for Exercise 3 file manager commonjs">
...
```bash
node Week6DatabasesAndNodejs/Day4NodejsIntroduction/Exercises/ExercisesXP/exercise-3-file-manager-commonjs/app.js
```
