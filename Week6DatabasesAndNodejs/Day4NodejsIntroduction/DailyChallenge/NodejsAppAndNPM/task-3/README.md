...
<img src="../../../../../assets/readme/progress/task-3-a8f915097a.svg" width="100%" alt="Readiness status for Task 3">
...
```bash
node Week6DatabasesAndNodejs/Day4NodejsIntroduction/DailyChallenge/NodejsAppAndNPM/task-3/app.js
```
